...
function generatePlot(event) {
  ...
  let context =
    "You are the best at giving movie plots. You mission is to generate a 4 line plot using HTML but dont show the html word. Make sure to follow the user instructions and make it clean. Always Include a title to the movie and its font should be small and always be centered. Sign the poem with 'SheCodes AI' inside a <strong> element at the end of the poem and NOT at the beginning";
